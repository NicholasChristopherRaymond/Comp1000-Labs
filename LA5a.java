...
public class LA5a {
	...
	public static void main(String[] args) {
		...
		fraction1[0] = scan.nextInt();
		System.out.print("Enter the denominator for the first fraction: ");
		fraction1[1] = scan.nextInt();
		System.out.print("Enter the numerator for the second fraction: ");
		fraction2[0] = scan.nextInt();
		System.out.print("Enter the denominator for the second fraction: ");
		fraction2[1] = scan.nextInt();
		System.out.print("Enter the operation (+, -, *, /): ");
		String op = scan.next();
		if(fraction1[1] == 0|| fraction2[1] == 0){
			System.out.println("Denominator cannot be zero.");	
		}
		else if(fraction2[0] == 0 && op.equals("/")) {
			System.out.println("Cannot divide by zero.");
		}
		else if(op.equals("/") != true && op.equals("*") != true && op.equals("+") != true && op.equals("-") != true) {
			System.out.println("Invalid operation.");
		}
		else{
			if(op.equals("+")) {
				int[] fraction3 = addFractions(fraction1, fraction2);
				if (fraction3[0] == 0) {
					System.out.printf(fraction1[0] + "/" + fraction1[1] + " " + op + " " + fraction2[0] + "/" + fraction2[1]  + " = 0" + "%n");
				}
				else if(fraction3[1] == 1) {
					System.out.printf(fraction1[0] + "/" + fraction1[1] + " " + op + " " + fraction2[0] + "/" + fraction2[1]  + " = " + fraction3[0] + "%n");
				}
				else if(fraction3[0] == fraction3[1]) {
					System.out.printf(fraction1[0] + "/" + fraction1[1] + " " + op + " " + fraction2[0] + "/" + fraction2[1]  + " = 1" + "%n");
				}
				else {
					System.out.printf(fraction1[0] + "/" + fraction1[1] + " " + op + " " + fraction2[0] + "/" + fraction2[1]  + " = "  + fraction3[0] + "/" + fraction3[1] + "%n");
				}
			}
			else if(op.equals("-")) {
				int[] fraction3 = subtractFractions(fraction1, fraction2);
				if (fraction3[0] == 0) {
					System.out.printf(fraction1[0] + "/" + fraction1[1] + " " + op + " " + fraction2[0] + "/" + fraction2[1]  + " = 0" + "%n");
				}
				else if(fraction3[1] == 1) {
				...
				int[] fraction3 = divideFractions(fraction1, fraction2);
				if (fraction3[0] == 0) {
					System.out.printf(fraction1[0] + "/" + fraction1[1] + " " + op + " " + fraction2[0] + "/" + fraction2[1]  + " = 0" + "%n");
				}
				else if(fraction3[1] == 1) {
				...
				int[] fraction3 = multiplyFractions(fraction1, fraction2);
				if (fraction3[0] == 0) {
					System.out.printf(fraction1[0] + "/" + fraction1[1] + " " + op + " " + fraction2[0] + "/" + fraction2[1]  + " = 0"  + "%n");
				}
				else if(fraction3[1] == 1) {
